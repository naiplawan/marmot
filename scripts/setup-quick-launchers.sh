#!/bin/bash
# Create Raycast script commands and Alfred keywords for Marmarmott (clean + uninstall).
...
write_raycast_script() {
    ...
    local marmot_bin="$3"
    local subcommand="$4"
    local raw_cmd="\"${marmot_bin}\" ${subcommand}"
...
main() {
    echo ""
    echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
    echo "  marmot Quick Launchers"
    echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"

    local marmot_bin
    marmot_bin="$(detect_marmot)"
    log_step "Detected marmot binary at: ${marmot_bin}"

    create_raycast_commands "$marmot_bin"
    create_alfred_workflow "$marmot_bin"
