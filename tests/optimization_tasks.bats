...
@test "opt_saved_state_cleanup removes old saved states" {
    ...
    # Make the file old (8+ days) - marmot_SAVED_STATE_AGE_DAYS defaults to 7
...
source "$PROJECT_ROOT/lib/core/common.sh"
source "$PROJECT_ROOT/lib/optimize/tasks.sh"
# marmot_MAIL_DOWNLOADS_MIN_KB is readonly, defaults to 5120 KB (~5MB)
opt_mail_downloads
EOF
...
@test "opt_mail_downloads removes old attachments" {
    ...
    # Make file old (31+ days) - marmot_LOG_AGE_DAYS defaults to 30
...
source "$PROJECT_ROOT/lib/core/common.sh"
source "$PROJECT_ROOT/lib/optimize/tasks.sh"
# marmot_MAIL_DOWNLOADS_MIN_KB and marmot_LOG_AGE_DAYS are readonly constants
opt_mail_downloads
EOF
